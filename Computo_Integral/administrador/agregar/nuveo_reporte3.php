...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/c/administrador/css/style3.css">
                ...
                <ul class="menu" style="text-align: center;">
                    <li><a href="#">Reportes</a>
                        <ul class="sub-menu">
                            ...
                            <li><a href="/Computo_Integral/administrador/eliminar/eliminar_reporte.php">Eliminar</a></li>
                            <li><a href="/Computo_Integral/administrador/cerrar/cerrar_reporte.php">Cerrar</a></li>
                        </ul>
                    </li>
                    <li><a href="#">Empresa</a>
                        <ul class="sub-menu">
                            ...
                            <li><a href="/Computo_Integral/administrador/cerrar/cerrar_empresa.php">Eliminar</a></li>
                    ...
                    <li><a href="#">Empleado</a>
                        <ul class="sub-menu">
                            ...
                            <li><a href="/Computo_Integral/administrador/eliminar/eliminar_empleado.php">Eliminar</a></li>

                        </ul>
                    </li>
                    <li><a href="/Computo_Integral/administrador/principal/principal_admin.php">Principal</a></li>
