...
<p>El Empleado /*<?php echo $nombre $ap_paterno $ap_materno?>
    ...
    fue Registro Exitoso</p>
        ...
        <p>¿Que deseas realizar?</p>
          ...
          <a href="/administrador/iframes/empleado_ci.php"><input type="button" value="Agregar Otro Empleado"> </a>
          <a href="/administrador/principal/principal_admin.php"><input type="button" value="Regresar Al Menu Principal"> </a>
                           <br>
					              <br>
