...
<html>
    ...
    <title>Servicio Requerido</title>
    <body id="cuerpo">
...
<!--                    <label  class='labels'>Tipo De Servicio:</label>
                    ...
                    <br>
                    <br>
<!--                    <label class='labels'>Fallas Encontradas:</label>
                    <textarea name="fallas_encontradas" rows="5" cols="60" size="255" id="reportadas"  ></textarea>-->
                    <br>
