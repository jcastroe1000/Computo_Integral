...
<html>
    ...
    <body id="cuerpo">
        ...
        <a href="/Computo_Integral/tecnico/iframes/empleado_ci.php"><input type="button" value="Agregar Otro Empleado"> </a>
        <a href="/Computo_Integral/tecnico/principal/principal_admin.php"><input type="button" value="Regresar Al Menu Principal"> </a>
        <br>
        <br>
