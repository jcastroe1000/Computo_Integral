   ...
   /*if (isset($_SESSION['s_rfc'])) {
	...
	$link = mysql_connect('localhost', 'root', '')or die('No se pudo conectar: ' . mysql_error());
	 $db=mysql_select_db('computo_integral', $link) or die('No se pudo seleccionar la base de datos');
      $consulta = mysql_query("select *from empleado_computo_integral WHERE RFC ='CAEA891208' ");
                       ...
                       <legend><label class='legends'>Datos Personales</label></legend>
                        ...
                        <br>
						 ...
						 <input type='text' class='inputs' value='".$mail."' name='email'  style='width:230px;' disabled>
                             ...
                             <br>
                    ";}
                   $consulta2 = mysql_query("select * from direccion_empleado WHERE rfc ='CAEA891208' ");
              ...
              echo "<fieldset class='fieldsets'>
               ...
               <legend><label class='legends'>Dirección</label></legend>
                   <div>
					   ...
					   <input type='text' class='inputs' value='".$row[8]."' name='direccion' disabled>
                    <br>
                       <label class='labels'>Num. Int:</label>
					   <input type='text' class='inputs' value='".$row[4]."' name='direccion' disabled>
                    ...
                    <br>
					   ...
					   <input type='text' class='inputs' value='".$row[7]."' name='direccion' disabled>
